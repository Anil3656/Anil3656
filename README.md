...
Associate Software Developer with more than 1+ years of strong professional experience in building **Python/Django-based web applications**, **Machine Learning models**, and **AI-powered systems**. Passionate about combining **backend development**, **Data Science**, **Generative AI**, and **Agentic AI** to design scalable, real-world solutions.
